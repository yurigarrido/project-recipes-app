...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-013-a-project-recipes-app.git`
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-013-a-project-recipes-app`
...
6. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-013-a-project-recipes-app/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-013-a-project-recipes-app/pulls) e confira que o seu _Pull Request_ está criado
